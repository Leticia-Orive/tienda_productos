...
// Para que sirve: Componente raíz de la aplicación React.
//   Configura BrowserRouter, anida todos los providers (Language, Auth, Product, Cart)
//   y define el árbol de rutas con lazy loading para minimizar el bundle inicial.
//   Las rutas privadas están protegidas con RequireAuth o RequireRole.
// Flujo principal: index.jsx monta <App /> → providers → Routes → componentes de página.
// Dónde tocar cambios: añade una nueva ruta en el bloque <Routes>; ajusta el orden de providers si se agrega uno nuevo.
