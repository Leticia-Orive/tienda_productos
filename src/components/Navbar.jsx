...
// Para que sirve: Barra de navegación principal de la aplicación.
//   Muestra enlaces de navegación, badges de carrito y favoritos, selector de idioma,
//   y un menú hamburguesa responsivo para móvil con focus trap y cierre con Escape.
//   Destaca la ruta activa para facilitar la orientación del usuario (WCAG 2.4.8).
// Flujo principal: Navbar → hooks (useCart, useAuth, useLanguage) → renderiza según estado.
// Dónde tocar cambios: enlace nuevo en la lista de rutas; estilos de Tailwind para el breakpoint.
