        ...
        >
          ...
          {!isAdmin && (
            <Link to="/favoritos" onClick={closeMenu} className={linkClass('/favoritos')} aria-label={`Favoritos, ${favoriteCount} guardados`}>
              ❤ Favoritos {favoriteCount > 0 && <span className="ml-1 text-xs font-bold text-rose-500">({favoriteCount})</span>}
            </Link>
          )}
          {!isAdmin && (
            <Link to="/carrito" onClick={closeMenu} className={linkClass('/carrito')}>
              🛒 Carrito {totalItems > 0 && <span className="ml-1 text-xs font-bold text-indigo-600">({totalItems})</span>}
            </Link>
          )}
