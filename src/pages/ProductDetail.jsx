...
export default function ProductDetail() {
  ...
  /** Removes the current product from cart if present. */
  const handleDelete = () => {
    if (!isInCart) {
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="mt-2 grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <button
              ...
              className="rounded-lg border border-red-300 bg-white px-4 py-2.5 text-sm font-semibold text-red-600 transition hover:bg-red-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500"
            >
              Borrar
            </button>
            <button
