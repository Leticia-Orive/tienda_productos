...
// Para que sirve: Página de detalle de un producto individual.
//   Muestra imagen, descripción, precio, categoría y acciones: añadir al carrito,
//   togglear favorito y compartir (Web Share API o copia al portapapeles).
//   Usa los hooks granulares del carrito (useCartItems, useFavorites, useCartUI)
//   para minimizar re-renders.
// Flujo principal: useParams(id) → busca producto → renderiza; Navigate si no existe.
// Dónde tocar cambios: secciones de compartir (ShareData) o la lógica de favoritos.
