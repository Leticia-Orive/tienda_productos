...
// Para que sirve: Pagina de listado principal con filtros, busqueda, orden y paginacion.
...
// Generated by GitHub Copilot — merged into a single import to satisfy the one-import-per-module rule.
...
/* Maintenance guide:
 * - Filters/search/pagination state lives inside this page and is mirrored to URL + localStorage.
 * - Product sort modes are controlled by ALLOWED_SORTS and the sort useMemo below.
 * - "Novedades" behavior depends on NEW_PRODUCTS_WINDOW and newestMinId.
 * - Price analytics cards use priceStats and are computed from currently filtered products.
 */
...
export default function Home() {
   ...
   * useCallback keeps the reference stable so goToPage / resetToFirstPage /
   * clearFilters are not recreated on every render.
   */
  const rememberCategoryPage = useCallback((categoryName, page) => {
  ...
  }, [activeCategorySafe, rememberCategoryPage, totalPages]);
  ...
  const resetToFirstPage = useCallback(() => {
    ...
    setRenderChunk(1);
    setCurrentPage(1);
  }, [activeCategorySafe, rememberCategoryPage]);
