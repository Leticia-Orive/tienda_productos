...
// Para que sirve: Página de registro de nuevo usuario.
//   Valida nombre, email, contraseña y confirmación; comprueba la fortaleza de la clave;
//   llama a AuthContext.register() y redirige al inicio de sesión tras éxito.
// Flujo principal: formulario → validateForm → register() en AuthContext → /login.
// Dónde tocar cambios: reglas de validación de contraseña; textos en LanguageContext.
