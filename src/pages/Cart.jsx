...
// Para que sirve: Página del carrito de compras.
//   Muestra los productos añadidos, permite ajustar cantidades, eliminar ítems y vaciar el carrito.
//   Incluye un campo de cupón con validación y aviso de caducidad, y un resumen del total con descuento.
//   Redirige a /checkout al pulsar "Pagar".
// Flujo principal: CartContext (items, coupon, totals) → render → acciones de usuario → CartContext.
// Dónde tocar cambios: lógica de cupones en coupons.js; lógica de carrito en CartContext.jsx.
