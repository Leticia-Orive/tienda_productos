      ...
      <main className="min-h-screen flex items-center justify-center px-4 py-20" role="status" aria-live="polite">
        ...
        <div className="max-w-md w-full text-center">
          ...
          <div className="success-content">
            ...
            <Link
              to="/pedidos"
              className="success-button inline-block rounded-xl bg-indigo-600 px-8 py-3 font-semibold text-white transition hover:bg-indigo-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 w-full"
            >
