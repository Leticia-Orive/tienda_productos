        ...
        <section className="flex-1" aria-label="Formulario de envío y pago">
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
            <fieldset className="flex flex-col gap-4">
              ...
              <CheckoutField id="name" label="Nombre completo" name="name" placeholder="Ana García" autoComplete="name" value={form.name} hasError={Boolean(touched.name && errors.name)} errorMessage={errors.name} onChange={handleChange} onBlur={handleBlur} />
              <CheckoutField id="email" label="Correo electrónico" name="email" type="email" placeholder="ana@correo.com" autoComplete="email" value={form.email} hasError={Boolean(touched.email && errors.email)} errorMessage={errors.email} onChange={handleChange} onBlur={handleBlur} />
            </fieldset>

            <fieldset className="flex flex-col gap-4">
              <legend className="font-semibold text-gray-800 text-base mb-1">Dirección de envío</legend>
              <CheckoutField id="address" label="Calle y número" name="address" placeholder="Av. Libertad 1234" autoComplete="street-address" value={form.address} hasError={Boolean(touched.address && errors.address)} errorMessage={errors.address} onChange={handleChange} onBlur={handleBlur} />
              <div className="grid grid-cols-2 gap-4">
                ...
                <CheckoutField id="zip" label="Código postal" name="zip" placeholder="1425" autoComplete="postal-code" value={form.zip} hasError={Boolean(touched.zip && errors.zip)} errorMessage={errors.zip} onChange={handleChange} onBlur={handleBlur} />
              </div>
            ...
            >
              Confirmar pedido — ${payableTotal.toFixed(2)}
            </button>
          </form>
        </section>
