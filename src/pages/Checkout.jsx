...
export default function Checkout() {
  ...
  function validateField(name, value) {
    ...
    if (name === 'phone') {
      if (!value.trim() || !/^[\d\s\+\-\(\)]{9,}$/.test(value)) {
  ...
  const downloadOrderSummary = () => {
    const orderNumber = `${form.name.split(' ')[0]}-${Math.random().toString(36).slice(2, 8).toUpperCase()}`;
    const summary = {
      orderNumber,
    ...
    link.href = url;
    link.download = `pedido-${orderNumber}.json`;
    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-4 py-20" role="status" aria-live="polite">
        ...
        <div className="max-w-md w-full text-center">
          <div className="success-icon mb-6 inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-green-400 to-emerald-600">
          ...
          <div className="success-content">
            ...
            <div className="bg-indigo-50 rounded-lg p-4 mb-6 border border-indigo-200">
              ...
              <p className="text-lg font-mono font-bold text-indigo-600">{form.name.split(' ')[0]}-{Math.random().toString(36).slice(2, 8).toUpperCase()}</p>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 rounded-xl border-2 border-indigo-600 px-8 py-3 font-semibold text-indigo-600 transition hover:bg-indigo-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              ...
              <Link
                to="/pedidos"
                className="flex-1 success-button inline-block rounded-xl bg-indigo-600 px-8 py-3 font-semibold text-white transition hover:bg-indigo-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
